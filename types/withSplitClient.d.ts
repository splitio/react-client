 ...
 */
declare function withSplitClient(splitKey: SplitIO.SplitKey, trafficType?: string): <OuterProps>(WrappedComponent: React.ComponentType<OuterProps & ISplitClientChildProps>, updateOnSdkUpdate?: boolean, updateOnSdkTimedout?: boolean, updateOnSdkReady?: boolean) => (props: OuterProps) => JSX.Element;

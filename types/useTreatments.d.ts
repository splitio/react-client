 ...
 */
declare const useTreatments: (splitNames: string[], attributes?: import("@splitsoftware/splitio/types/splitio").Attributes | undefined, key?: string | import("@splitsoftware/splitio/types/splitio").SplitKeyObject | undefined) => SplitIO.TreatmentsWithConfig;

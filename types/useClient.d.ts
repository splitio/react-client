 ...
 */
declare const useClient: (key?: string | import("@splitsoftware/splitio/types/splitio").SplitKeyObject | undefined, trafficType?: string | undefined) => SplitIO.IClient | null;

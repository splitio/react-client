 ...
 */
declare const useClient: (key?: string | import("@splitsoftware/splitio/types/splitio").SplitKeyObject | undefined, trafficType?: string | undefined) => import("@splitsoftware/splitio/types/splitio").IClient | null;

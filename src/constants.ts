...
export const ERROR_UC_NO_USECONTEXT: string = '[ERROR] Returning a null client from `useClient` hook since React `useContext` is not available. Check your React version. Split hooks require version 16.8.0+ of React.';

export const ERROR_UM_NO_USECONTEXT: string = '[ERROR] Returning a null manager from `useManager` hook since React `useContext` is not available. Check your React version. Split hooks require version 16.8.0+ of React.';

export const ERROR_UT_NO_USECONTEXT: string = '[ERROR] Returning control treatments from `useTreatments` hook since React `useContext` is not available. Check your React version. Split hooks require version 16.8.0+ of React.';

export const ERROR_UTRACK_NO_USECONTEXT: string = '[ERROR] Returning a no-op function from `useTrack` hook since React `useContext` is not available. Check your React version. Split hooks require version 16.8.0+ of React.';

export const EXCEPTION_NO_CREATECONTEXT: string = 'React `createContext` function is not available. Check your React version. Split SDK is compatible with version 16.3.0+ of React.';

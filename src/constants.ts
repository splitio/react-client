...
export const EXCEPTION_NO_REACT_OR_CREATECONTEXT: string = 'Check that React library is properly installed since React `createContext` function is not available. Split SDK requires version 16.3.0+ of React.';
